...
export default defineConfig({
	...
	head: [
		...
		[
			"meta",
			{ name: "title", content: "@sylphx/cat - Ultra-fast, lightweight logger for JavaScript" },
		],
		[
			"meta",
			{
				name: "description",
				content:
					"The fastest, lightest, and most extensible logger for all JavaScript runtimes. 82% smaller than Pino, zero dependencies, full TypeScript support.",
			},
		],
		[
			"meta",
			{
				name: "keywords",
				content:
					"logger, logging, javascript, typescript, bun, nodejs, pino, winston, opentelemetry, w3c-trace-context, observability",
			},
		],
		...
		[
			...
			{
				property: "og:title",
				content: "@sylphx/cat - Ultra-fast, lightweight logger for JavaScript",
			},
		],
		[
			"meta",
